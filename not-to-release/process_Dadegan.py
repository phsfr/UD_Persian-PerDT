...
def convert_pos(old_pos, word_form):
    ...
    adj_prenums = ['تک', 'نصف', 'چند', 'دهمین', 'آخرین', 'یکمین', 'سی‌امین', 'هفتمین', 'بیستمین', 'سومین', 'پنجمین',
                   'شصتمین', 'نهمین', 'دومین', 'اول', 'چهاردهمین', 'چهارمین', 'اولین', 'هشتمین', 'دوازدهمین', 'ششمین',
                   'یازدهمین', 'نخستین']
            ...
            if pos == 'V' and (' ' in word_form):
                ...
                if len(verb_parts) == 2:  # normalizing two part verbs
                    ...
                    if aux_form:
                        ...
                        eddited_line = str(
                            token_id) + '\t' + v_first_part + '\t' + word_lemma + '\t' + 'V' + '\t' + 'V_PP' + '\t' + 'number=SING|person=3' + polarity_v + '|tense=Past' + old_dadegan_info_v + '\t' + hParent + '\t' + rParent + '\t' + semanticRoles + '\n'
                        spaceAft = '_'
                        if noSpace:
                    ...
                    if v_second_part == 'شده' or v_second_part == 'نشده':
                        ...
                        old_dadegan_info_v = '|tma=' + seperated_feature[
                            'tma'] + '|Dadeg_pos=' + pos + '|Dadeg_fpos=' + cpos + '|senID=' + seperated_feature[
                                                 'senID']
                        eddited_line = str(
                            token_id) + '\t' + v_first_part + '\t' + word_lemma + '\t' + 'V' + '\t' + 'V_PP' + '\t' + 'number=SING|person=3|tense=Past' + old_dadegan_info_v + '\t' + hParent + '\t' + rParent + '\t' + semanticRoles + '\n'
                        added_line_verb_one = 'X' + '\t' + str(
                            v_p_one_id) + '\t' + v_second_part_form + '\t' + 'کرد#کن' + '\t' + 'AUX' + '\t' + 'V_PP' + '\t' + 'number=SING|person=3' + polarity + '|tense=Past' + old_dadegan_info_aux + '\t' + str(
